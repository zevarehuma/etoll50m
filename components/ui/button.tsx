...
const variants={default:'bg-gradient-to-br from-sky-400 to-teal-300 text-slate-900 hover:opacity-90',outline:'border border-white/15 bg-transparent text-slate-100 hover:bg-white/5',ghost:'bg-transparent hover:bg-white/5 text-slate-100'}
