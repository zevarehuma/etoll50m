  ...
  return (
    <div className='min-h-screen'>
      <header className='sticky top-0 z-50 border-b border-teal-300/20 bg-[#0b1221]/70 backdrop-blur'>
        <div className='mx-auto flex max-w-6xl items-center justify-between px-4 py-3'>
          <div className='flex items-center gap-3'>
            <div className='grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-sky-400 to-teal-300 text-slate-900 font-extrabold'>e</div>
            <div className='text-lg font-bold tracking-wide'>eToll50M</div>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <Card>
              ...
              <CardContent className='space-y-3'>
                ...
                <p className='text-xs text-slate-400'>Payment is simulated for this demo. Connect your PSP.</p>
              </CardContent>
            </Card>
          </motion.div>
        </div>
      ...
      <section id='contact' className='mx-auto max-w-6xl px-4 py-10'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
          <Card><CardContent className='pt-6'><div className='font-semibold'>Support</div><div className='text-slate-300'>support@etoll50m.dog</div></CardContent></Card>
      ...
      <footer className='border-t border-white/10 py-6 text-sm text-slate-300'>
        <div className='mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4'>
          <div>© {new Date().getFullYear()} eToll50M. All rights reserved.</div>
